...
class BursaryOffice extends StatefulWidget {
  const BursaryOffice({super.key});
  static const routeName = '/busrary=apvrl';

  @override
  State<BursaryOffice> createState() => _BursaryOfficeState();
}

class _BursaryOfficeState extends State<BursaryOffice> {
