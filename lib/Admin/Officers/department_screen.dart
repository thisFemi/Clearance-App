...
class DepartmentalScreen extends StatefulWidget {
  const DepartmentalScreen({super.key});
  static const routeName = '/dpt=apvrl';

  @override
  State<DepartmentalScreen> createState() => _DepartmentalScreenState();
}

class _DepartmentalScreenState extends State<DepartmentalScreen> {
