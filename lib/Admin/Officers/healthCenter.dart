...
class HealthOffice extends StatefulWidget {
  const HealthOffice({super.key});
  static const routeName = '/health=apvrl';

  @override
  State<HealthOffice> createState() => _HealthOfficeState();
}

class _HealthOfficeState extends State<HealthOffice> {
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                      ...
                                      child: Text(loadedClearance.healthUrl)),
                                  TextButton(
                                    onPressed: () async {
                                      var url = loadedClearance.healthUrl;
                                      ...
                                      child: Center(
                                        child: Container(
                                          ...
                                          child: Checkbox(
                                              ...
                                              // checkColor: color9,
                                              value:
                                                  loadedClearance.isTechnologistCheck,
