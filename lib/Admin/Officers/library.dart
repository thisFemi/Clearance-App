...
class LibraryOffice extends StatefulWidget {
  const LibraryOffice({super.key});
  static const routeName = '/lib=apvrl';

  @override
  State<LibraryOffice> createState() => _LibraryOfficeState();
}

class _LibraryOfficeState extends State<LibraryOffice> {
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                      ...
                                      child: Text(loadedClearance.libraryUrl)),
                                  TextButton(
                                    onPressed: () async {
                                      var url = loadedClearance.libraryUrl;
