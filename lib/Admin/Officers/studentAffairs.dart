...
class StudentAffairsOffice extends StatefulWidget {
  const StudentAffairsOffice({super.key});
  static const routeName = '/stdAffairs=apvrl';

  @override
  State<StudentAffairsOffice> createState() => _StudentAffairsOfficeState();
}

class _StudentAffairsOfficeState extends State<StudentAffairsOffice> {
